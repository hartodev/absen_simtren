...
<body class="noise" style="min-height:100dvh; overflow-x:hidden;">
    ...
    <!-- ======================= TRUST STRIP ======================= -->
    <section class="border-b border-[#e5ebf4] bg-white py-7">
    ...
    <!-- ======================= MODULES ======================= -->
    <section id="fitur" class="bg-[#f3f7fc] py-24 sm:py-32">
        <div class="section-wrap">
            ...
            <div class="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-4" id="modules-grid"></div>
        </div>
    </section>

    <!-- ======================= DIRECTORY / WEBSITE MITRA ======================= -->
    <section id="website-mitra" class="bg-white py-24 sm:py-32">
        <div class="section-wrap">
    ...
    <!-- ======================= HOW IT WORKS ======================= -->
    <section id="cara-kerja" class="bg-[#102b69] py-24 text-white sm:py-32">
        <div class="section-wrap">
            <div class="max-w-2xl">
            ...
            <div class="mt-14 grid gap-5 md:grid-cols-3" id="steps-grid"></div>
        </div>
    </section>
    ...
    <section class="bg-white py-24 sm:py-32">
        <div class="section-wrap">
            ...
            <div class="mt-14 grid items-center gap-12 lg:grid-cols-[1.2fr_.8fr]">
    ...
    <!-- ======================= TESTIMONIALS ======================= -->
    <section class="bg-[#f3f7fc] py-24 sm:py-32">
        <div class="section-wrap">
            <div class="max-w-2xl">
            ...
            <div class="mt-14 grid gap-4 lg:grid-cols-3" id="testimonials-grid"></div>
        </div>
    </section>

    <!-- ======================= PRICING ======================= -->
    <section id="harga" class="bg-white py-24 sm:py-32">
        <div class="section-wrap">
            ...
            <div class="mx-auto mt-14 grid max-w-[1080px] gap-4 lg:grid-cols-3" id="pricing-grid"></div>
        </div>
    </section>

    <!-- ======================= FAQ ======================= -->
    <section id="faq" class="bg-[#f3f7fc] py-24 sm:py-32">
    ...
    <!-- ======================= SCHEDULE DEMO ======================= -->
    <section id="mulai" class="relative overflow-hidden bg-[#102b69] py-24 text-white sm:py-32">
