...
@section('title', $theme === 'green' ? 'Lainnya' : 'Profil')

@section('content')
@php $isGreen = $theme === 'green'; @endphp

<div class="flex items-center gap-3 rounded-3xl bg-white p-4 shadow-sm ring-1 ring-black/5">
    <span class="flex h-14 w-14 items-center justify-center rounded-full text-lg font-bold text-white" style="background: var(--brand)">
...
@if ($isGreen)
    <div class="mt-4 overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-black/5">
        @foreach ([
            ...
            <a href="{{ $url }}" class="flex items-center gap-3 border-b border-slate-100 px-4 py-3.5 last:border-0">
