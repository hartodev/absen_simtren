    ...
    <main class="flex min-h-[100dvh] items-center justify-center bg-[#f3f7fc] px-4 py-10">
        <div
            ...
            <p class="mt-3 text-sm leading-6 text-[#71839b]">
                Lembaga <span class="font-bold text-[#102b69]">{{ $company->name }}</span> belum diaktivasi. Cek email
                admin yang didaftarkan untuk link aktivasi, atau kirim ulang di bawah ini.
            </p>
