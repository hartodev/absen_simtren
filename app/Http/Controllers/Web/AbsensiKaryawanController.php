...
class AbsensiKaryawanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tenant.absensi-karyawan.index', compact('absensi', 'karyawan'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.absensi-karyawan.create', compact('karyawan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tenant.absensi-karyawan.index')->with('success', 'Absensi karyawan berhasil dicatat.');
    }
    ...
    public function edit(AbsensiKaryawan $absensiKaryawan)
    {
        ...
        return view('tenant.absensi-karyawan.edit', [
    ...
    public function update(Request $request, AbsensiKaryawan $absensiKaryawan)
    {
        ...
        return redirect()->route('tenant.absensi-karyawan.index')->with('success', 'Absensi karyawan berhasil diperbarui.');
    }
    ...
    public function destroy(AbsensiKaryawan $absensiKaryawan)
    {
        ...
        return redirect()->route('tenant.absensi-karyawan.index')->with('success', 'Absensi karyawan berhasil dihapus.');
    }
    ...
    public function absenMandiri()
    {
        ...
        return view('tenant.absensi-karyawan.absen', compact('karyawan', 'absensiHariIni', 'today'));
    }
